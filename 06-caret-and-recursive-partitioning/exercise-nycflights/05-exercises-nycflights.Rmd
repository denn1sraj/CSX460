...
# The model is pretty good -- it uses a good amount of the features to determine the outfrom for arrival delay. Even though ituses more features than just the rpart model below, it still is highly interpretable but retails both high accuracy and 0.9219 and a decent Kappa over just the expected values of 0.7363. The model also only predicts 13263 late flights while missing 4684 actually late flights, while the naive model would over predict 20259 late flights. 
